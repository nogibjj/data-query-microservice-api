...
def get_temperatures_top5():
    ...
    seasons_df_list = [winter.to_json(), spring.to_json(), summer.to_json(), autumn.to_json()]
    ...
    bottom_collapsed = bottom5.groupby(['year','season', 'country']).mean().reset_index()
    ...
    seasons_df_list = seasons_df_list + [winter_2.to_json(), spring_2.to_json(), summer_2.to_json(), autumn_2.to_json()]
